...
class Ui_CrickRivals(object):
    def setupUi(self, CrickRivals):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("C:/Users/DHRUV JAIN/Downloads/ChatGPT Image Jun 6, 2025, 12_42_43 PM.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(155, 300, 86, 61))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(250, 300, 201, 61))
